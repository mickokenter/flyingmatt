...
public class ParkOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_park_one);
        ...
        String address = "Park One:\n" +
                "762 W Jackson Blvd, Chicago, IL 60661\n" +
                "(312) 725-9131\n" +
                "$15/hr";
