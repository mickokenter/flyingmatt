...
public class PeopleAuto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_people_auto);
        ...
        String address = "People's Auto Parking:\n" +
                "568 W Van Buren St, Chicago, IL 60607\n" +
                "parkingcarma.com\n" +
                "(312) 913-9770\n" +
                "$18/hr";
