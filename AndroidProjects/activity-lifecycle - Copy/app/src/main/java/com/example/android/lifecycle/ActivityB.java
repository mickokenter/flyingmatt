...
public class ActivityB extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        counterB();
        Log.d("<xqiu12>:", "<" + cnumberB + "> - ActivityB: OnCreate()");
    }
    ...
    protected void onStart() {
        ...
        Utils.printStatus(mStatusView, mStatusAllView);
        counterB();
        Log.d("<xqiu12>:", "<" + cnumberB + "> - ActivityB: OnStart()");
    }
    ...
    protected void onRestart() {
        ...
        Utils.printStatus(mStatusView, mStatusAllView);
        counterB();
        Log.d("<xqiu12>:", "<" + cnumberB + "> - ActivityB: OnRestart()");
    }
    ...
    protected void onResume() {
        ...
        Utils.printStatus(mStatusView, mStatusAllView);
        counterB();
        Log.d("<xqiu12>:", "<" + cnumberB + "> - ActivityB: OnResume()");
    }
    ...
    protected void onPause() {
        ...
        Utils.printStatus(mStatusView, mStatusAllView);
        counterB();
        Log.d("<xqiu12>:", "<" + cnumberB + "> - ActivityB: OnPause()");
    }
    ...
    protected void onStop() {
        ...
        counterB();
        Log.d("<xqiu12>:", "<" + cnumberB + "> - ActivityB: OnStop()");
    }
